<form action="{{ action('RefJurusanController@destroy', $jurusan->id) }}" method="POST" id="kantorCabangForm">
	...
	<div class="modal-body">
		...
		<div class="form-group row">
			<div class="col-md-12 text-center">
				...
				<hr>
				<h5>
					APAKAH ANDA YAKIN AKAN MENGHAPUS JURUSAN {{ strtoupper($jurusan->name) }} ?
				</h5>
			</div>
		</div>
	</div>
