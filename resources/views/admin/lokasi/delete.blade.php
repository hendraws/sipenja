<form action="{{ action('LokasiTutorialController@destroy', $lokasi) }}" method="POST" id="kantorCabangForm">
	...
	<div class="modal-body">
		...
		<div class="form-group row">
			<div class="col-md-12 text-center">
				...
				<hr>
				<h5>
					APAKAH ANDA YAKIN AKAN MENGHAPUS LOKASI <b>{{ strtoupper($lokasi->lokasi) }}</b> ?
				</h5>
			</div>
		</div>
	</div>
