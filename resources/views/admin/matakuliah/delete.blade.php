<form action="{{ action('MataKuliahController@destroy', $matakuliah) }}" method="POST" id="kantorCabangForm">
	...
	<div class="modal-body">
		...
		<div class="form-group row">
			<div class="col-md-12 text-center">
				...
				<hr>
				<h5>
					APAKAH ANDA YAKIN AKAN MENGHAPUS MATAKULIAH {{ strtoupper($matakuliah->nama_mk) }} ?
				</h5>
			</div>
		</div>
	</div>
