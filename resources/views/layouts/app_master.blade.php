...
<head>
	...
	<title>@yield('title') | Sistem Informasi Pengelola Jadwal Tutorial </title>
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="/" class="brand-link navbar-light">
				<img src="{{ asset('dist/img/logo-ut.png') }}" alt="AdminLTE Logo" class="brand-image " style="opacity: .8">
